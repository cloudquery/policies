{% macro sql_postgresql_log_disconnections_flag_off(framework, check_id) %}
  {{ return(adapter.dispatch('sql_postgresql_log_disconnections_flag_off')(framework, check_id)) }}
{% endmacro %}

{% macro default__sql_postgresql_log_disconnections_flag_off(framework, check_id) %}{% endmacro %}
...
{% macro snowflake__sql_postgresql_log_disconnections_flag_off(framework, check_id) %}
 WITH 
    instance_flags as (
    select
        f.value as value             
