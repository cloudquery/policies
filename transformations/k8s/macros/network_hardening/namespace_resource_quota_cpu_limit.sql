{% macro namespace_resource_quota_cpu_limit(framework, check_id) %}
  {{ return(adapter.dispatch('namespace_resource_quota_cpu_limit')(framework, check_id)) }}
{% endmacro %}

{% macro default__namespace_resource_quota_cpu_limit(framework, check_id) %}{% endmacro %}

{% macro postgres__namespace_resource_quota_cpu_limit(framework, check_id) %}
