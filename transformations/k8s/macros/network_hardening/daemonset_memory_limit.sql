{% macro daemonset_memory_limit(framework, check_id) %}
  {{ return(adapter.dispatch('daemonset_memory_limit')(framework, check_id)) }}
{% endmacro %}

{% macro default__daemonset_memory_limit(framework, check_id) %}{% endmacro %}

{% macro postgres__daemonset_memory_limit(framework, check_id) %}
