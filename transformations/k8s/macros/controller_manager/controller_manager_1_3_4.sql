{% macro controller_manager_1_3_4(framework, check_id) %}
  {{ return(adapter.dispatch('controller_manager_1_3_4')(framework, check_id)) }}
{% endmacro %}

{% macro default__controller_manager_1_3_4(framework, check_id) %}{% endmacro %}

{% macro postgres__controller_manager_1_3_4(framework, check_id) %}
WITH
...
{% macro snowflake__controller_manager_1_3_4(framework, check_id) %}
WITH
  pod_containers_commands
    AS (
      SELECT
...
{% macro bigquery__controller_manager_1_3_4(framework, check_id) %}
