{% macro pod_security_standards_5_2_9(framework, check_id) %}
  {{ return(adapter.dispatch('pod_security_standards_5_2_9')(framework, check_id)) }}
{% endmacro %}

{% macro default__pod_security_standards_5_2_9(framework, check_id) %}{% endmacro %}

{% macro postgres__pod_security_standards_5_2_9(framework, check_id) %}
WITH pod_containers
    AS (
      SELECT
...
{% macro snowflake__pod_security_standards_5_2_9(framework, check_id) %}
WITH pod_containers
    AS (
      SELECT
...
{% macro bigquery__pod_security_standards_5_2_9(framework, check_id) %}
