{% macro recovery_redshift_snapshots_cur_2(framework, check_id) %}
  {{ return(adapter.dispatch('recovery_redshift_snapshots_cur_2')(framework, check_id)) }}
{% endmacro %}

{% macro default__recovery_redshift_snapshots_cur_2(framework, check_id) %}{% endmacro %}

{% macro postgres__recovery_redshift_snapshots_cur_2(framework, check_id) %}
...
{% macro snowflake__recovery_redshift_snapshots_cur_2(framework, check_id) %}
