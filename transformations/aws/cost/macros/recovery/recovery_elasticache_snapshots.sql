{% macro recovery_elasticache_snapshots_cur_2(framework, check_id) %}
  {{ return(adapter.dispatch('recovery_elasticache_snapshots_cur_2')(framework, check_id)) }}
{% endmacro %}

{% macro default__recovery_elasticache_snapshots_cur_2(framework, check_id) %}{% endmacro %}

{% macro postgres__recovery_elasticache_snapshots_cur_2(framework, check_id) %}
...
{% macro snowflake__recovery_elasticache_snapshots_cur_2(framework, check_id) %}
