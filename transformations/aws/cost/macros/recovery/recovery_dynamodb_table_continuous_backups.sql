{% macro recovery_dynamodb_table_continuous_backups_cur_2(framework, check_id) %}
  {{ return(adapter.dispatch('recovery_dynamodb_table_continuous_backups_cur_2')(framework, check_id)) }}
{% endmacro %}

{% macro default__recovery_dynamodb_table_continuous_backups_cur_2(framework, check_id) %}{% endmacro %}

{% macro postgres__recovery_dynamodb_table_continuous_backups_cur_2(framework, check_id) %}
...
{% macro snowflake__recovery_dynamodb_table_continuous_backups_cur_2(framework, check_id) %}
