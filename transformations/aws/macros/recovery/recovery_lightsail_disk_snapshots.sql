{% macro recovery_lightsail_disk_snapshots(framework, check_id) %}
  {{ return(adapter.dispatch('recovery_lightsail_disk_snapshots')(framework, check_id)) }}
{% endmacro %}

{% macro default__recovery_lightsail_disk_snapshots(framework, check_id) %}{% endmacro %}
...
{% macro snowflake__recovery_lightsail_disk_snapshots(framework, check_id) %}
