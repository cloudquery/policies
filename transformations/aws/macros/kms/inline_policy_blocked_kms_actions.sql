{% macro inline_policy_blocked_kms_actions(framework, check_id) %}
  {{ return(adapter.dispatch('inline_policy_blocked_kms_actions')(framework, check_id)) }}
{% endmacro %}

{% macro default__inline_policy_blocked_kms_actions(framework, check_id) %}{% endmacro %}

{% macro postgres__inline_policy_blocked_kms_actions(framework, check_id) %}
select
