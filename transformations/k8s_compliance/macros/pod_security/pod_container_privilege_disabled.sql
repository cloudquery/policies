{% macro pod_container_privilege_disabled(framework, check_id) %}
  {{ return(adapter.dispatch('pod_container_privilege_disabled')(framework, check_id)) }}
{% endmacro %}

{% macro default__pod_container_privilege_disabled(framework, check_id) %}{% endmacro %}

{% macro postgres__pod_container_privilege_disabled(framework, check_id) %}
