{% macro replicaset_container_privilege_disabled(framework, check_id) %}
  {{ return(adapter.dispatch('replicaset_container_privilege_disabled')(framework, check_id)) }}
{% endmacro %}

{% macro default__replicaset_container_privilege_disabled(framework, check_id) %}{% endmacro %}

{% macro postgres__replicaset_container_privilege_disabled(framework, check_id) %}
