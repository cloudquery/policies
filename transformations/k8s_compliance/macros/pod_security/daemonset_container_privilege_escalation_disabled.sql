{% macro daemonset_container_privilege_escalation_disabled(framework, check_id) %}
  {{ return(adapter.dispatch('daemonset_container_privilege_escalation_disabled')(framework, check_id)) }}
{% endmacro %}

{% macro default__daemonset_container_privilege_escalation_disabled(framework, check_id) %}{% endmacro %}

{% macro postgres__daemonset_container_privilege_escalation_disabled(framework, check_id) %}
