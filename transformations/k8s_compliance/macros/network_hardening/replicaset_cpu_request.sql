{% macro replicaset_cpu_request(framework, check_id) %}
  {{ return(adapter.dispatch('replicaset_cpu_request')(framework, check_id)) }}
{% endmacro %}

{% macro default__replicaset_cpu_request(framework, check_id) %}{% endmacro %}

{% macro postgres__replicaset_cpu_request(framework, check_id) %}
