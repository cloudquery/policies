...
Welcome to Azure Compliance Package, a compliance solution that works on top of the CloudQuery framework. This package offers automated checks across various Azure services, following benchmarks such as CIS and HIPPA.
...
FROM azure_compliance__cis_v_2_0_0
WHERE status = 'fail'
```

Which resource failed the most tests in the HIPPA HITRUST benchmark? (Postgres)
```sql
...
Automated compliance checks following CIS and HIPPA
...
- **azure_compliance\_\_cis_v1_3_0.sql**: Azure Compliance CIS V1.3.0, available for PostgreSQL, Snowflake and BigQuery.
- **azure_compliance\_\_cis_v2_0_0.sql**: Azure Compliance CIS V2.0.0, available for PostgreSQL, Snowflake and BigQuery.
