{% macro network_rdp_services_are_restricted_from_the_internet(framework, check_id) %}
  {{ return(adapter.dispatch('network_rdp_services_are_restricted_from_the_internet')(framework, check_id)) }}
{% endmacro %}

{% macro default__network_rdp_services_are_restricted_from_the_internet(framework, check_id) %}{% endmacro %}
...
{% macro bigquery__network_rdp_services_are_restricted_from_the_internet(framework, check_id) %}
WITH conditions AS (
    SELECT
        subscription_id,
        id,
