{% macro monitor_log_alert_for_create_or_update_network_sg_rule(framework, check_id) %}
  {{ return(adapter.dispatch('monitor_log_alert_for_create_or_update_network_sg_rule')(framework, check_id)) }}
{% endmacro %}

{% macro default__monitor_log_alert_for_create_or_update_network_sg_rule(framework, check_id) %}{% endmacro %}
