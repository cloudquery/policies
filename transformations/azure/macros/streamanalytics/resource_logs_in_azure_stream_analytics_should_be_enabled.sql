{% macro streamanalytics_resource_logs_in_azure_stream_analytics_should_be_enabled(framework, check_id) %}
WITH
...
FROM azure_streamanalytics_streaming_jobs j
         LEFT JOIN logging_enabled e ON j._cq_id = e._cq_id{% endmacro %}