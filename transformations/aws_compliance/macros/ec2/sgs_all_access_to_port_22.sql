{% macro sgs_all_access_to_port_22(framework, check_id) %}
  {{ return(adapter.dispatch('sgs_all_access_to_port_22')(framework, check_id)) }}
{% endmacro %}

{% macro default__sgs_all_access_to_port_22(framework, check_id) %}{% endmacro %}

{% macro postgres__sgs_all_access_to_port_22(framework, check_id) %}
-- TODO FIXME
