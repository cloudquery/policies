{% macro no_broad_public_ipv4_ingress_on_port_22_3389(framework, check_id) %}
  {{ return(adapter.dispatch('no_broad_public_ipv4_ingress_on_port_22_3389')(framework, check_id)) }}
{% endmacro %}

{% macro default__no_broad_public_ipv4_ingress_on_port_22_3389(framework, check_id) %}{% endmacro %}

{% macro postgres__no_broad_public_ipv4_ingress_on_port_22_3389(framework, check_id) %}
