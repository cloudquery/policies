{% macro rds_event_notifications_subscription_should_be_configured_for_critical_cluster_events(framework, check_id) %}
  {{ return(adapter.dispatch('rds_event_notifications_subscription_should_be_configured_for_critical_cluster_events')(framework, check_id)) }}
{% endmacro %}

{% macro default__rds_event_notifications_subscription_should_be_configured_for_critical_cluster_events(framework, check_id) %}{% endmacro %}

{% macro postgres__rds_event_notifications_subscription_should_be_configured_for_critical_cluster_events(framework, check_id) %}
