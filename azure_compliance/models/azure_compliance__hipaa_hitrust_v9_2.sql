...
union        
({{security_mfa_should_be_enabled_on_accounts_with_owner_permissions_on_your_subscription('hipaa_hitrust_v9.2','1121_01j3organizational_2_01_j')}})
union
({{security_mfa_should_be_enabled_accounts_with_write_permissions_on_your_subscription('hipaa_hitrust_v9.2','1173_01j1organizational_6_01_j')}})
union        
({{security_mfa_should_be_enabled_on_accounts_with_read_permissions_on_your_subscription('hipaa_hitrust_v9.2','1174_01j1organizational_7_01_j')}})
union
({{compute_virtual_machines_without_jit_network_access_policy('hipaa_hitrust_v9.2','1175_01j1organizational_8_01_j')}})
union
--segregation_in_networks
({{security_mfa_should_be_enabled_on_accounts_with_owner_permissions_on_your_subscription('hipaa_hitrust_v9.2','1176_01j2organizational_5_01_j')}})
union
({{security_mfa_should_be_enabled_accounts_with_write_permissions_on_your_subscription('hipaa_hitrust_v9.2','1177_01j2organizational_6_01_j')}})
union
({{security_mfa_should_be_enabled_on_accounts_with_read_permissions_on_your_subscription('hipaa_hitrust_v9.2','1178_01j2organizational_7_01_j')}})
union
({{compute_virtual_machines_without_jit_network_access_policy('hipaa_hitrust_v9.2','1179_01j3organizational_1_01_j')}})
union
...
union
({{storage_accounts_with_no_service_endpoint_associated('hipaa_hitrust_v9.2','0806.01m2Organizational.12356 - 01.m - 9')}})
union
...
union
({{compute_vms_without_approved_networks('hipaa_hitrust_v9.2','0805.01m1Organizational.12 - 01.m - 11')}})
union
({{network_subnets_without_nsg_associated('hipaa_hitrust_v9.2','0805.01m1Organizational.12 - 01.m - 10')}})
union
...
union
({{keyvault_vaults_with_no_service_endpoint('hipaa_hitrust_v9.2','0805.01m1Organizational.12 - 01.m - 7')}})
union
({{compute_internet_facing_virtual_machines_should_be_protected_with_network_security_groups('hipaa_hitrust_v9.2','0805.01m1Organizational.12 - 01.m - 6')}})
union
...
union
({{eventhub_event_hub_should_use_a_virtual_network_service_endpoint('hipaa_hitrust_v9.2','0805.01m1Organizational.12 - 01.m - 4')}})
union
({{cosmosdb_cosmos_db_should_use_a_virtual_network_service_endpoint('hipaa_hitrust_v9.2','0805.01m1Organizational.12 - 01.m - 3')}})
union
({{network_virtualnetworkserviceendpoint_appservice_auditifnotexists('hipaa_hitrust_v9.2','0805.01m1Organizational.12 - 01.m - 2')}})
union
({{container_containers_without_virtual_service_endpoint('hipaa_hitrust_v9.2','0805.01m1Organizational.12 - 01.m - 1')}})
union
--network_connection_control
({{web_api_app_should_only_be_accessible_over_https('hipaa_hitrust_v9.2','0809.01n2Organizational.1234 - 01.n - 2')}})
union
...
union
({{compute_internet_facing_virtual_machines_should_be_protected_with_network_security_groups('hipaa_hitrust_v9.2','0809.01n2Organizational.1234 - 01.n - 6')}})
union
...
union
({{redis_only_secure_connections_to_your_azure_cache_for_redis_should_be_enabled('hipaa_hitrust_v9.2','0809.01n2Organizational.1234 - 01.n - 10')}})
union
({{storage_secure_transfer_to_storage_accounts_should_be_enabled('hipaa_hitrust_v9.2','0809.01n2Organizational.1234 - 01.n - 11')}})
union
({{network_subnets_without_nsg_associated('hipaa_hitrust_v9.2','0809.01n2Organizational.1234 - 01.n - 12')}})
union
({{compute_vms_without_approved_networks('hipaa_hitrust_v9.2','0809.01n2Organizational.1234 - 01.n - 13')}})
union
...
union
({{security_mfa_should_be_enabled_on_accounts_with_owner_permissions_on_your_subscription('hipaa_hitrust_v9.2','11109.01q1Organizational.57 - 01.q - 1')}})
union
({{security_mfa_should_be_enabled_accounts_with_write_permissions_on_your_subscription('hipaa_hitrust_v9.2','11110.01q1Organizational.6 - 01.q - 1')}})
union
({{security_mfa_should_be_enabled_on_accounts_with_read_permissions_on_your_subscription('hipaa_hitrust_v9.2','11111.01q2System.4 - 01.q - 1')}})
union
...
union
({{web_function_app_should_only_be_accessible_over_https('hipaa_hitrust_v9.2','1402.05i1Organizational.45 - 05.i - 1')}})
union
({{web_web_application_should_only_be_accessible_over_https('hipaa_hitrust_v9.2','1403.05i1Organizational.67 - 05.i - 1')}})
union
({{mysql_enforce_ssl_connection_should_be_enabled_for_mysql_database_servers('hipaa_hitrust_v9.2','1418.05i1Organizational.8 - 05.i - 1')}})
union
({{postgresql_enforce_ssl_connection_should_be_enabled_for_postgresql_database_servers('hipaa_hitrust_v9.2','1450.05i2Organizational.2 - 05.i - 1')}})
union
...
union
({{monitor_azure_monitor_should_collect_activity_logs_from_all_regions('hipaa_hitrust_v9.2','1214.09ab2System.3456 - 09.ab - 1')}})
union
({{compute_machines_without_log_analytics_agent('hipaa_hitrust_v9.2','1215.09ab2System.7 - 09.ab - 1')}})
--dup
union
({{compute_scale_sets_without_log_analytics_agent('hipaa_hitrust_v9.2','1216.09ab3System.12 - 09.ab - 1')}})
union
({{monitor_azure_monitor_log_profile_should_collect_logs_for_categories_write_delete_and_action('hipaa_hitrust_v9.2','1217.09ab3System.3 - 09.ab - 1')}})
--dup
union
({{monitor_azure_monitor_log_profile_should_collect_logs_for_categories_write_delete_and_action('hipaa_hitrust_v9.2','1219.09ab3System.10 - 09.ab - 1')}})
--dup
union
({{security_asc_automatic_provisioning_log_analytics_monitoring_agent('hipaa_hitrust_v9.2','1220.09ab3System.56 - 09.ab - 1')}})
--dup
...
union
({{monitor_activitylog_administrativeoperations_audit('hipaa_hitrust_v9.2','1271.09ad1System.1 - 09.ad - 1')}})
--dup
...
union
({{sql_long_term_geo_redundant_backup_should_be_enabled_for_azure_sql_databases('hipaa_hitrust_v9.2','1621.09l2Organizational.1 - 09.l - 1')}})
--dup
union
({{sql_mysql_servers_without_geo_redundant_backups('hipaa_hitrust_v9.2','1622.09l2Organizational.23 - 09.l - 1')}})
--dup
union
({{sql_postgresql_servers_without_geo_redundant_backups('hipaa_hitrust_v9.2','1623.09l2Organizational.4 - 09.l - 1')}})
--dup
union
({{sql_mariadb_servers_without_geo_redundant_backups('hipaa_hitrust_v9.2','1624.09l3Organizational.12 - 09.l - 1')}})
--dup
union
({{sql_postgresql_servers_without_geo_redundant_backups('hipaa_hitrust_v9.2','1626.09l3Organizational.5 - 09.l - 1')}})
union
--dup
({{sql_mariadb_servers_without_geo_redundant_backups('hipaa_hitrust_v9.2','1627.09l3Organizational.6 - 09.l - 1')}})
--network_controls
union
({{network_asc_unprotectedendpoints_audit('hipaa_hitrust_v9.2','0858.09m1Organizational.4 - 09.m - 1')}})
union
({{compute_virtual_machines_without_jit_network_access_policy('hipaa_hitrust_v9.2','0858.09m1Organizational.4 - 09.m - 2')}})
union
({{network_virtualnetworkserviceendpoint_appservice_auditifnotexists('hipaa_hitrust_v9.2','0861.09m2Organizational.67 - 09.m - 1')}})
union
({{eventhub_event_hub_should_use_a_virtual_network_service_endpoint('hipaa_hitrust_v9.2','0863.09m2Organizational.910 - 09.m - 1')}})
union
({{cosmosdb_cosmos_db_should_use_a_virtual_network_service_endpoint('hipaa_hitrust_v9.2','0864.09m2Organizational.12 - 09.m - 1')}})
union
({{keyvault_vaults_with_no_service_endpoint('hipaa_hitrust_v9.2','0865.09m2Organizational.13 - 09.m - 1')}})
union
({{storage_accounts_with_unrestricted_access('hipaa_hitrust_v9.2','0866.09m3Organizational.1516 - 09.m - 1')}})
union
({{storage_accounts_with_no_service_endpoint_associated('hipaa_hitrust_v9.2','0867.09m3Organizational.17 - 09.m - 1')}})
union
({{container_containers_without_virtual_service_endpoint('hipaa_hitrust_v9.2','0868.09m3Organizational.18 - 09.m - 1')}})
--dup
union
({{container_containers_without_virtual_service_endpoint('hipaa_hitrust_v9.2','0869.09m3Organizational.19 - 09.m - 1')}})
--dup
union
({{container_containers_without_virtual_service_endpoint('hipaa_hitrust_v9.2','0870.09m3Organizational.20 - 09.m - 1')}})
--dup
union
({{container_containers_without_virtual_service_endpoint('hipaa_hitrust_v9.2','0871.09m3Organizational.22 - 09.m - 1')}})
--dup
...
union
({{account_locations_without_network_watchers('hipaa_hitrust_v9.2','0837.09.n2Organizational.2 - 09.n - 1')}})
union
({{compute_linux_machines_without_data_collection_agent('hipaa_hitrust_v9.2','0885.09n2Organizational.3 - 09.n - 1')}})
--dup
union
({{account_locations_without_network_watchers('hipaa_hitrust_v9.2','0886.09n2Organizational.4 - 09.n - 1')}})
--dup
union
({{compute_windows_machines_without_data_collection_agent('hipaa_hitrust_v9.2','0887.09n2Organizational.5 - 09.n - 1')}})
--dup
union
({{account_locations_without_network_watchers('hipaa_hitrust_v9.2','0888.09n2Organizational.6 - 09.n - 1')}})
--dup
...
union
({{storage_secure_transfer_to_storage_accounts_should_be_enabled('hipaa_hitrust_v9.2','0943.09y1Organizational.1 - 09.y - 1')}})
union
({{redis_only_secure_connections_to_your_azure_cache_for_redis_should_be_enabled('hipaa_hitrust_v9.2','0946.09y2Organizational.14 - 09.y - 1')}})
union
({{postgresql_enforce_ssl_connection_should_be_enabled_for_postgresql_database_servers('hipaa_hitrust_v9.2','0947.09y2Organizational.2 - 09.y - 1')}})
union
({{mysql_enforce_ssl_connection_should_be_enabled_for_mysql_database_servers('hipaa_hitrust_v9.2','0948.09y2Organizational.3 - 09.y - 1')}})
union
({{web_api_app_should_only_be_accessible_over_https('hipaa_hitrust_v9.2','0949.09y2Organizational.5 - 09.y - 1')}})
union
({{web_function_app_should_only_be_accessible_over_https('hipaa_hitrust_v9.2','0949.09y2Organizational.5 - 09.y - 2')}})
union
({{web_latest_tls_version_should_be_used_in_your_api_app('hipaa_hitrust_v9.2','0949.09y2Organizational.5 - 09.y - 3')}})
union
({{web_latest_tls_version_should_be_used_in_your_function_app('hipaa_hitrust_v9.2','0949.09y2Organizational.5 - 09.y - 4')}})
union
({{web_latest_tls_version_should_be_used_in_your_web_app('hipaa_hitrust_v9.2','0949.09y2Organizational.5 - 09.y - 1')}})
union
({{web_web_application_should_only_be_accessible_over_https('hipaa_hitrust_v9.2','0949.09y2Organizational.5 - 09.y - 1')}})
union
({{web_app_client_cert_disabled('hipaa_hitrust_v9.2','0915.09s2Organizational.2 - 09.s - 1')}})
union
({{web_cors_should_not_allow_every_resource_to_access_your_web_applications('hipaa_hitrust_v9.2','0916.09s2Organizational.4 - 09.s - 1')}})
union
({{web_cors_should_not_allow_every_resource_to_access_your_function_apps('hipaa_hitrust_v9.2','0960.09sCSPOrganizational.1 - 09.s - 1')}})
union
({{web_remote_debugging_should_be_turned_off_for_function_apps('hipaa_hitrust_v9.2','1325.09s1Organizational.3 - 09.s - 1')}})
...
union
({{sql_managed_instances_without_vulnerability_assessments('hipaa_hitrust_v9.2','0710.10m2Organizational.1 - 10.m')}})
--dup
union
({{compute_machines_without_vulnerability_assessment_extension('hipaa_hitrust_v9.2','0711.10m2Organizational.23 - 10.m')}})
--dup
union
({{sql_sql_databases_with_unresolved_vulnerability_findings('hipaa_hitrust_v9.2','0716.10m3Organizational.1 - 10.m - 1')}})
--dup
union
({{sql_managed_instances_without_vulnerability_assessments('hipaa_hitrust_v9.2','0719.10m3Organizational.5 - 10.m - 1')}})
--dup
...
union
({{compute_audit_virtual_machines_without_disaster_recovery_configured('hipaa_hitrust_v9.2','1638.12b2Organizational.345 - 12.b - 1')}})
--dup
 )
select *
from aggregated
